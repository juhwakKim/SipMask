...
from mmdet.core import distance2bbox, bbox_overlaps, multi_apply, multiclass_nms
...
def multiclass_nms_idx(multi_bboxes,
    ...
    multi_idxs = torch.arange(0, multi_scores.shape[0], dtype=torch.long).to('cuda')
    ...
    for i in range(1, num_classes):
        ...
        _idxs = multi_idxs[cls_inds.to('cuda')]
...
class SipMaskHead(nn.Module):
    ...
    def _init_layers(self):
        ...
        if self.rescoring_flag:
            ...
            self.mask_scoring = nn.Conv2d(128, self.num_classes, 1)
    ...
    def get_bboxes_single(self,
        ...
        if det_bboxes.shape[0]>0:
            ...
            if self.rescoring_flag:
                ...
                mask_scores = [mask_scores[det_labels.cpu().numpy() == i] for i in range(self.num_classes)]
