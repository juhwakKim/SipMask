...
from mmdet.core import distance2bbox, bbox_overlaps, multi_apply, multiclass_nms, multiclass_nms_idx
    ...
    def get_bboxes_single(self,
        ...
        if det_bboxes.shape[0]>0:
            ...
            if self.ssd_flag:
                ...
                masks = F.interpolate(pos_masks.unsqueeze(0), scale_factor=tuple(scale / scale_factor[0:2]), mode='bilinear', align_corners=False).squeeze(0)
            masks.gt_(0.4)
