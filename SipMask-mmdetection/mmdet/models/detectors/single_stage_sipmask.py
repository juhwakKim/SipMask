...
class SingleStageSipMaskDetector(BaseDetector):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(SingleStageSipMaskDetector, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        # super(SingleStageSipMaskDetector, self).init_weights(pretrained)
